...
Generated: 2026-09-18T09:50:54.538131+00:00
...
- Catalog `lowturn`: see catalog_note/ids below; skip 7d; default-grid reference N=[21, 63, 126] (K=13 untouched); k in [3, 5]; weights ['ew', 'iv']; rebalance `monday_utc_close_fill_next_open`; MIN_CROSS_SECTION=10; eligibility N+8 bars.
...
Frozen lower-turnover catalog (K=13): `xs_topk_lt_{ew|iv}_{N}_k{3|5}` for N in [126, 252, 378] (12 baskets) plus informational control `ew_bh_universe` (cannot promote). Distinct from the default K=13 TOPK_CATALOG - do not retune either list after seeing PnL. PAPER_PROMOTE_* stays false.

Frozen core ids: `xs_topk_lt_ew_126_k3`, `xs_topk_lt_ew_126_k5`, `xs_topk_lt_ew_252_k3`, `xs_topk_lt_ew_252_k5`, `xs_topk_lt_ew_378_k3`, `xs_topk_lt_ew_378_k5`, `xs_topk_lt_iv_126_k3`, `xs_topk_lt_iv_126_k5`, `xs_topk_lt_iv_252_k3`, `xs_topk_lt_iv_252_k5`, `xs_topk_lt_iv_378_k3`, `xs_topk_lt_iv_378_k5`, `ew_bh_universe`.
...
| --- | --- | --- | :---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :---: |
| `xs_topk_lt_ew_126_k3` | `kraken` | 2024-2026 | yes | 720 | -65.24% | -73.79% | -43.57% | -30.23% | -0.607 | +86.10% | 10.157 | +3.44% | +17.72% | FAIL |
| `xs_topk_lt_ew_126_k5` | `kraken` | 2024-2026 | yes | 720 | -58.75% | -67.74% | -43.57% | -24.18% | -0.524 | +82.93% | 8.776 | +3.42% | +17.72% | FAIL |
| `xs_topk_lt_ew_252_k3` | `kraken` | 2024-2026 | yes | 720 | -11.31% | -27.17% | -43.57% | +16.40% | -0.040 | +72.96% | 7.062 | +4.05% | +21.26% | FAIL |
| `xs_topk_lt_ew_252_k5` | `kraken` | 2024-2026 | yes | 720 | -28.11% | -41.68% | -43.57% | +1.88% | -0.292 | +72.73% | 7.502 | +3.84% | +20.04% | FAIL |
| `xs_topk_lt_ew_378_k3` | `kraken` | 2024-2026 | yes | 720 | -38.65% | -43.25% | -43.57% | +0.31% | -0.493 | +64.53% | 2.833 | +1.02% | +5.63% | FAIL |
| `xs_topk_lt_ew_378_k5` | `kraken` | 2024-2026 | yes | 720 | -42.72% | -48.02% | -43.57% | -4.46% | -0.650 | +67.09% | 3.529 | +1.21% | +6.62% | FAIL |
| `xs_topk_lt_iv_126_k3` | `kraken` | 2024-2026 | yes | 720 | -57.49% | -68.85% | -43.57% | -25.29% | -0.515 | +83.62% | 11.152 | +4.19% | +21.24% | FAIL |
| `xs_topk_lt_iv_126_k5` | `kraken` | 2024-2026 | yes | 720 | -54.33% | -65.31% | -43.57% | -21.75% | -0.501 | +81.76% | 9.778 | +3.80% | +19.50% | FAIL |
| `xs_topk_lt_iv_252_k3` | `kraken` | 2024-2026 | yes | 720 | -2.42% | -22.43% | -43.57% | +21.14% | -0.010 | +71.95% | 8.242 | +4.88% | +25.26% | FAIL |
| `xs_topk_lt_iv_252_k5` | `kraken` | 2024-2026 | yes | 720 | -27.94% | -42.34% | -43.57% | +1.22% | -0.363 | +71.97% | 8.005 | +4.07% | +21.12% | FAIL |
| `xs_topk_lt_iv_378_k3` | `kraken` | 2024-2026 | yes | 720 | -36.07% | -41.48% | -43.57% | +2.09% | -0.503 | +62.03% | 3.215 | +1.19% | +6.50% | FAIL |
| `xs_topk_lt_iv_378_k5` | `kraken` | 2024-2026 | yes | 720 | -40.46% | -46.77% | -43.57% | -3.20% | -0.668 | +65.55% | 4.072 | +1.43% | +7.76% | FAIL |
| `ew_bh_universe` | `kraken` | 2024-2026 | yes | 720 | -40.21% | -43.57% | -43.57% | +0.00% | -0.039 | +81.52% | 2.094 | +1.27% | +7.05% | control |
| `xs_topk_lt_ew_126_k3` | `coinbase` | 2024-2026 | yes | 724 | -73.15% | -80.69% | -35.70% | -44.99% | -0.959 | +89.29% | 11.574 | +3.71% | +18.87% | FAIL |
| `xs_topk_lt_ew_126_k5` | `coinbase` | 2024-2026 | yes | 724 | -68.50% | -75.70% | -35.70% | -40.00% | -0.760 | +86.20% | 9.221 | +3.18% | +16.47% | FAIL |
| `xs_topk_lt_ew_252_k3` | `coinbase` | 2024-2026 | yes | 724 | -34.12% | -44.58% | -35.70% | -8.88% | -0.317 | +79.81% | 6.145 | +3.44% | +18.33% | FAIL |
| `xs_topk_lt_ew_252_k5` | `coinbase` | 2024-2026 | yes | 724 | -21.17% | -34.69% | -35.70% | +1.01% | -0.168 | +71.84% | 6.702 | +3.82% | +20.08% | FAIL |
| `xs_topk_lt_ew_378_k3` | `coinbase` | 2024-2026 | yes | 724 | -49.84% | -53.43% | -35.70% | -17.73% | -0.722 | +70.96% | 2.640 | +0.90% | +4.96% | FAIL |
| `xs_topk_lt_ew_378_k5` | `coinbase` | 2024-2026 | yes | 724 | -44.80% | -49.12% | -35.70% | -13.42% | -0.664 | +67.78% | 2.927 | +1.09% | +6.00% | FAIL |
| `xs_topk_lt_iv_126_k3` | `coinbase` | 2024-2026 | yes | 724 | -65.61% | -75.74% | -35.70% | -40.04% | -0.811 | +86.77% | 12.251 | +4.34% | +21.79% | FAIL |
| `xs_topk_lt_iv_126_k5` | `coinbase` | 2024-2026 | yes | 724 | -63.84% | -72.80% | -35.70% | -37.10% | -0.719 | +84.46% | 10.138 | +3.60% | +18.41% | FAIL |
| `xs_topk_lt_iv_252_k3` | `coinbase` | 2024-2026 | yes | 724 | -28.94% | -41.94% | -35.70% | -6.24% | -0.310 | +77.98% | 7.192 | +4.07% | +21.38% | FAIL |
| `xs_topk_lt_iv_252_k5` | `coinbase` | 2024-2026 | yes | 724 | -21.26% | -35.58% | -35.70% | +0.12% | -0.221 | +71.90% | 7.139 | +4.16% | +21.75% | FAIL |
| `xs_topk_lt_iv_378_k3` | `coinbase` | 2024-2026 | yes | 724 | -47.15% | -51.45% | -35.70% | -15.76% | -0.719 | +68.43% | 3.010 | +1.05% | +5.77% | FAIL |
| `xs_topk_lt_iv_378_k5` | `coinbase` | 2024-2026 | yes | 724 | -40.94% | -46.51% | -35.70% | -10.81% | -0.641 | +65.35% | 3.541 | +1.36% | +7.43% | FAIL |
...
| --- | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | :---: | ---: | :---: | :---: |
| `xs_topk_lt_ew_126_k3` | 126 | 3 | ew | kraken, coinbase | 2 | 0 | 2 | 2 | -37.61% | no | — | no | no |
| `xs_topk_lt_ew_126_k5` | 126 | 5 | ew | kraken, coinbase | 2 | 0 | 2 | 0 | -32.09% | no | — | no | no |
| `xs_topk_lt_ew_252_k3` | 252 | 3 | ew | kraken, coinbase | 2 | 0 | 2 | 1 | +3.76% | no | — | no | no |
| `xs_topk_lt_ew_252_k5` | 252 | 5 | ew | kraken, coinbase | 2 | 0 | 2 | 2 | +1.45% | no | — | no | no |
| `xs_topk_lt_ew_378_k3` | 378 | 3 | ew | kraken, coinbase | 2 | 0 | 2 | 2 | -8.71% | no | — | no | no |
| `xs_topk_lt_ew_378_k5` | 378 | 5 | ew | kraken, coinbase | 2 | 0 | 2 | 2 | -8.94% | no | — | no | no |
| `xs_topk_lt_iv_126_k3` | 126 | 3 | iv | kraken, coinbase | 2 | 0 | 2 | 2 | -32.66% | no | — | no | no |
| `xs_topk_lt_iv_126_k5` | 126 | 5 | iv | kraken, coinbase | 2 | 0 | 2 | 1 | -29.42% | no | — | no | no |
| `xs_topk_lt_iv_252_k3` | 252 | 3 | iv | kraken, coinbase | 2 | 0 | 2 | 1 | +7.45% | no | — | no | no |
| `xs_topk_lt_iv_252_k5` | 252 | 5 | iv | kraken, coinbase | 2 | 0 | 2 | 2 | +0.67% | no | — | no | no |
| `xs_topk_lt_iv_378_k3` | 378 | 3 | iv | kraken, coinbase | 2 | 0 | 2 | 2 | -6.84% | no | — | no | no |
| `xs_topk_lt_iv_378_k5` | 378 | 5 | iv | kraken, coinbase | 2 | 0 | 2 | 2 | -7.01% | no | — | no | no |
