...
def test_policy_version_moves_with_every_declared_risk_limit() -> None:
    ...
    changes: dict[str, object] = {
        ...
        "pretrade_candle_count": 300,
        "pretrade_min_candles": 100,
        "pretrade_max_candle_age_seconds": 3_600.0,
        "pretrade_min_excess_return": 0.01,
        "pretrade_max_drawdown_pct": 0.20,
        "pretrade_min_sharpe": 0.5,
        "pretrade_min_trades": 5,
        "pretrade_require_walkforward": False,
        "pretrade_fee_bps": 20.0,
        "pretrade_slippage_bps": 10.0,
        "max_spread_bps": 15.0,
